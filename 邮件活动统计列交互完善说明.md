...
##### 添加对话框组件
```typescript
<DeliveriesDialog {...deliveriesDialog} onClose={...} />
...
**数据来源**: `send_logs` 表（`status = 'delivered'`）
